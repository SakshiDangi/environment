...
import { ArrowRight, LucideTrees, Recycle, Users, Coins, MapPin, ChevronRight } from 'lucide-react'
...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <LucideTrees className="absolute inset-0 m-auto h-16 w-16 text-green-600 animate-pulse" />
    </div>
  )
}
    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Eco-Friendly <span className="text-green-600">Waste Management Application</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Join our community to contribute in Environment Sustainability & making waste management more efficient and rewarding!
        </p>
        {!loggedIn ? (
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="CO2 Offset" value={`${impactData.co2Offset} kg`} icon={LucideTrees} />
        </div>
      </section>
