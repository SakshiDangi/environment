...
import { Menu, Coins, Search, Bell, User, ChevronDown, LogIn, LucideTrees } from "lucide-react"
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
      ...
      <div className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            <LucideTrees className="h-6 w-6 md:h-8 md:w-8 text-green-500 mr-1 md:mr-2" />
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">Environment</span>
